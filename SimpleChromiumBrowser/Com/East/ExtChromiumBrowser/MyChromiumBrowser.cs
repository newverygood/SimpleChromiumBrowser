...
using SimpleChromiumBrowser.Com.East.Util;
using System;
...
namespace SimpleChromiumBrowser.Com.East.ExtChromiumBrowser
{
    ...
    class MyChromiumBrowser: Control
    {
        ...
        /// 获取实例
        /// </summary>
        public static MyChromiumBrowser Instance(Form window) {

            mainWindowPanel = new Panel();
            mainWindow = window;
            mainWindow.Controls.Add(mainWindowPanel);
            ...
            //添加到窗体中的panel容器中
            mainWindowPanel.Controls.Add(webBrowser);

            mainWindowPanel.Dock = DockStyle.Fill;
            mainWindowPanel.SizeChanged += Panel_SizeChanged;
